 ...
 */
function sendResponse(input, context, responseStatus, reason) {
...
exports.initializer = async (input, context) => {
	...
	try {
		...
		sendResponse(input, context, "SUCCESS", null);

	} catch (error) {
		sendResponse(input, context, "SUCCESS", error);
	}
